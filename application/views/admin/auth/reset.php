...
<meta charset="utf-8" />
<title><?php echo $title; ?> | American Laptop Admin</title>
...
<div class="container">
  <div class="row login-container animated fadeInUp">  
      ...
      <?php 
          $attributes = array( 'name' => 'formResetPassword', 'id' => 'formResetPassword', 'class' => 'animated fadeIn');
		...
		<div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
			...
			<button type="submit" class="btn btn-primary btn-cons" id="login_toggle">Update Your Password</button>
