            ...
            <div class="pull-right"> 
                <div class="chat-toggler">  
                    ...
                    <div class="profile-pic"> 
                        <img src="/assets/img/profiles/mohsin1.jpg" alt="" data-src="/assets/img/profiles/mohsin1.jpg" data-src-retina="/assets/img/profiles/mohsin1.jpg" width="40" height="55" /> 
                    </div>  
                    <!-- END PROFILE PICTURE -->                
                </div>
    ...
    <div class="page-sidebar" id="main-menu"> 
        ...
        <div class="user-info-wrapper"> 
            <div class="profile-wrapper">
                <img src="/assets/img/profiles/mohsin.jpg" alt="" data-src="/assets/img/profiles/mohsin.jpg" data-src-retina="/assets/img/profiles/mohsin1.jpg" width="80" height="99" />
            </div>
            <div class="user-info">
                <div class="greeting">Welcome</div>
                <div class="username">Hafiz <span class="semi-bold">Mohsin</span></div> &nbsp; &nbsp;
            </div>
        </div>
        <!-- END MINI-PROFILE -->
        <!-- BEGIN SIDEBAR MENU --> 
