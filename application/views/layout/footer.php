        ...
        <div class="row">
          <div class="contact col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <ul>
              ...
              <li class="email"><i class="fa fa-envelope"></i>Send email via our <a href="/home/contact">Contact Us</a>
            </ul>
          </div>
          ...
          <div class="column col-lg-2 col-md-2 col-sm-3 col-xs-12">
            <h5>My Account</h5>
            <ul>
              <li><a href="/user/register">My Account</a></li>
              <li><a href="/user/register">Sign Up</a></li>
              <li><a href="/user/register">Order History</a></li>
