        ...
        <div id="content" class="col-sm-12">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td class="text-center"><a href="product.html"><img src="assets/image/product/samsung_tab_1-50x50.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" /></a></td>
                ...
                <tr>
                  <td class="text-center"><a href="product.html"><img src="assets/image/product/sony_vaio_1-50x50.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" /></a></td>
